...
class React_OptionsKit {
	...
	/**
	 * Determine whether we're on an options page generated by WPROK.
	 *
	 * @return boolean
	 */
	...
	private function get_registered_settings_sections() {
		return \apply_filters( $this->func . '_registered_settings_sections', array() );
	}
	...
	private function get_options() {
		...
		// Loop through each available setting, and set up the setting in the array.
